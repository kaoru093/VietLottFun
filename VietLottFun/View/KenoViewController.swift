...
class KenoViewController: UIViewController {
    ...
    private func setupTopStack() {
        ...
        topStack.heightAnchor.constraint(equalTo: view.safeAreaLayoutGuide.heightAnchor, multiplier: 0.3).isActive = true
        setupPickerStack()
    ...
    private func setupPickerStack() {
        ...
        pickerView.heightAnchor.constraint(equalTo: pickerStack.heightAnchor, multiplier: 0.7).isActive = true
   ...
   //MARK: - Generate Button
    private func setupBottomStack() {
        ...
        generateButton.centerXAnchor.constraint(equalTo: bottomStack.centerXAnchor, constant: 0).isActive = true
        generateButton.centerYAnchor.constraint(equalTo: bottomStack.centerYAnchor, constant: 0).isActive = true
...
extension KenoViewController : UIPickerViewDelegate {
    func pickerView(_ pickerView: UIPickerView, rowHeightForComponent component: Int) -> CGFloat {
        return pickerView.frame.height*0.8
    }
